...
{
    #[Test]
    public function rule_validator_can_correctly_identify_rules(): void
    {
    ...
    #[Test]
    public function throws_exception_for_rule_not_declared(): void
    {
    ...
    #[Test]
    public function any_rule_returns_true_for_any(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function alpha_rule_returns_true_for_alpha(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function alpha_rule_returns_false_for_non_alpha(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function alphanum_rule_returns_true_for_alphanum(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function alphanum_rule_returns_false_for_non_alphanum(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function bool_rule_returns_true_for_bool(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function bool_rule_returns_false_for_non_bool(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function integer_rule_returns_true_for_integer(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function integer_rule_returns_false_for_non_integer(): void
    {
        $this->assertFalse(
            $this->makeComment()->settings()->isValid('integer', '7')
        );
    ...
    #[Test]
    public function numeric_rule_returns_true_for_numeric(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function numeric_rule_returns_false_for_non_numeric(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function range_rule_returns_true_for_value_in_range(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function range_rule_returns_true_for_value_at_low_end(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function range_rule_returns_true_for_value_at_high_end(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function range_rule_returns_false_for_value_out_of_range(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function range_rule_handles_negative_numbers(): void
    {
    ...
    #[Test]
    public function string_rule_returns_true_for_string(): void
    {
        $this->assertTrue(
    ...
    #[Test]
    public function string_rule_returns_false_for_non_string(): void
    {
        $this->assertFalse(
    ...
    #[Test]
    public function rules_can_be_user_defined(): void
    {
